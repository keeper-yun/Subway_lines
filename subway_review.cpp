...
//  总结：借助于gitee上bfs代码，CSDN上地铁线路搜索真实案例，chatGPT的修改和解读代码 
//
//	反思：1.没有提醒乘客换乘线路，如:东方之门(转1号线) 
//		  2.每次都要计算 ，冗余运算 ，可以设置memorandum备忘录 
//		  3.没有设置txt文件，将线路信息放入txt文件中，读取txt文件获得键值对，手动设置太麻烦了 
//		  4.设置的键值对好像冗余了，有一部分多出来了 
//
//	设计人员: 2200443011 王子超  2200443051 黄颖儿 
...
struct Station {
    ...
    vector<pair<string,string>> neighbors;
							...
							//类似于Java中的 List<String,String> HashMap,键值对 
...
int main() {
	...
	subwayMap["胥江路"] = {"胥江路", {{"桐泾公园", "Line2"}, {"劳动路", "Line2"}}};
	subwayMap["桐泾公园"] = {"桐泾公园", {{"友联", "Line2"}, {"胥江路", "Line2"}}};
	...
	subwayMap["松涛街"] = {"松涛街", {{"金谷路", "Line2"}, {"月亮湾", "Line2"}}};
	subwayMap["金谷路"] = {"金谷路", {{"金尚路", "Line2"}, {"松涛街", "Line2"}}};
	...
	//3号线新增线路 
	subwayMap["草鞋山"] = {"草鞋山", {{"唯亭", "Line3"}, {"阳澄湖东", "Line3"}}};
	subwayMap["阳澄湖东"] = {"阳澄湖东", {{"草鞋山", "Line3"}, {"正仪", "Line3"}}};
	subwayMap["正仪"] = {"正仪", {{"葑亭大道", "Line3"}, {"莲湖公园", "Line3"}}};
	subwayMap["莲湖公园"] = {"莲湖公园", {{"正仪", "Line3"}, {"祖冲之公园", "Line3"}}};
	subwayMap["祖冲之公园"] = {"祖冲之公园", {{"莲湖公园", "Line3"}, {"昆山文化艺术中心", "Line3"}}};
	subwayMap["昆山文化艺术中心"] = {"昆山文化艺术中心", {{"祖冲之公园", "Line3"}, {"共青", "Line3"}}};
	subwayMap["共青"] = {"共青", {{"昆山文化艺术中心", "Line3"}, {"江浦", "Line3"}}};
	subwayMap["江浦"] = {"江浦", {{"共青", "Line3"}, {"白马泾", "Line3"}}};
	subwayMap["白马泾"] = {"白马泾", {{"江浦", "Line3"}, {"玉山广场", "Line3"}}};
	subwayMap["玉山广场"] = {"玉山广场", {{"白马泾", "Line3"}, {"绣衣", "Line3"}}};
	subwayMap["绣衣"] = {"绣衣", {{"玉山广场", "Line3"}, {"昆山城市广场", "Line3"}}};
	subwayMap["昆山城市广场"] = {"昆山城市广场", {{"绣衣", "Line3"}, {"金浦大桥东", "Line3"}}};
	subwayMap["金浦大桥东"] = {"金浦大桥东", {{"昆山城市广场", "Line3"}, {"顺帆北路", "Line3"}}};
	subwayMap["顺帆北路"] = {"顺帆北路", {{"金浦大桥东", "Line3"}, {"鱼池泾", "Line3"}}};
	subwayMap["鱼池泾"] = {"鱼池泾", {{"顺帆北路", "Line3"}, {"白河谭", "Line3"}}};
	subwayMap["白河谭"] = {"白河谭", {{"鱼池泾", "Line3"}, {"兵希", "Line3"}}};
	subwayMap["兵希"] = {"兵希", {{"白河谭", "Line3"}, {"夏驾河公园", "Line3"}}};
	subwayMap["夏驾河公园"] = {"夏驾河公园", {{"兵希", "Line3"}, {"盛庄", "Line3"}}};
	subwayMap["盛庄"] = {"盛庄", {{"夏驾河公园", "Line3"}, {"章基路南", "Line3"}}};
	subwayMap["章基路南"] = {"章基路南", {{"盛庄", "Line3"}, {"夏桥", "Line3"}}};
	subwayMap["夏桥"] = {"夏桥", {{"章基路南", "Line3"}, {"神童泾", "Line3"}}};
	subwayMap["神童泾"] = {"神童泾", {{"夏桥", "Line3"}, {"菉葭", "Line3"}}};
	subwayMap["菉葭"] = {"菉葭", {{"神童泾", "Line3"}, {"花桥博览中心", "Line3"}}};
	subwayMap["花桥博览中心"] = {"花桥博览中心", {{"菉葭", "Line3"}, {"集善", "Line3"}}};
	subwayMap["集善"] = {"集善", {{"花桥博览中心", "Line3"}, {"花溪公园", "Line3"}}};
	subwayMap["花溪公园"] = {"花溪公园", {{"集善", "Line3"}, {"花桥", "Line3"}}};
	subwayMap["花桥"] = {"花桥", {{"花溪公园", "Line3"}  }};
